...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/kdeda/zstd-swift.git", from: "1.0.1"),
        .package(url: "https://github.com/kdeda/idd-objective-c-legacy.git", from: "1.0.1"),
        .package(url: "https://github.com/kdeda/log4swift.git", from: "1.0.1")
    ],
    targets: [
